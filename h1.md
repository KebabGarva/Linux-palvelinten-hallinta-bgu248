...
Tuli hieman tyhmä olo jälkeenpäin, koska olin käyttänyt Debianin epävakaata "trixie" -julkaisua, josta ei ole vieläkään julkistettu minkäänlaista mahdollista julkaisuajankohtaa. Ryhdyin heti luomaan uuden kansion uutta virtuaalikonetta varten, kunnes huomasin unohtaneeni luoneen aiemmin toisen kansion virtuaalikonetta varten. Halusin vaihtaa [debian/bullseye64 -versioon](https://app.vagrantup.com/debian/boxes/bullseye64), koska tiesin sen aiemman kokemuksen perusteella olevan vakaa, ja jossa toimii salt. Varmistin ensin vanhan virtuaalikoneen olevan poistettu, ja sen jälkeen pyöritin komennon `vagrant init debian/bullseye64 --force ; vagrant up`
