...
Esimerkiksi, jos haluan lisätä hakemiston “Eeppiset animetappelut” nykyisen käyttäjän kotihakemistoon,  ja määritelty hakemisto puuttuu, file.directory -tilafunktio lisää kyseisen hakemiston kotihakemistoon. Jos komennon suorittaa uudelleen, uutta “Eeppiset animetappelut” -hakemistoa ei lisätä kotihakemistoon. Jos halutaan lisätä uusi hakemisto, on muokattava alkuperäistä komentoa. Uuden komennon tarvittavat muutokset on lisättävän kansion uusi sijainti tai nimi.
...
Jos komennon suorittaa uudelleen, uutta “Eeppiset animetappelut” -hakemistoa ei lisätä kotihakemistoon. Jos halutaan lisätä uusi hakemisto, on muokattava alkuperäistä komentoa. Uuden komennon tarvittavat muutokset on lisättävän kansion uusi sijainti tai nimi.
