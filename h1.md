...
Tämä raportti on tehty Tero Karvisen toteuttaman kurssin Palvelinten hallinta yhteydessä. Tämä raportti kertoo läpikohtaisesti, mitä tein tehtävän h1 eteen. Sisällysluettelon linkkejä painamalla pystyy navigoimaan suoraan haluttuun kohtaan.
...
EDIT: Kirjoitus-, ja kielioppivirheitä saattaa olla paikoittain, mutta en fyysisesti ja henkisesti jaksa lähteä nyt korjaamaan niitä, koska olen käyttänyt tähän raporttiin aivan käsittämättömän verran aikaa. Ellen ole väärässä, raportin tekemiseen meni n. 30 tuntia. Pitäisikö tähän edes käyttää niin paljon aikaa? Mun yöunet on hiema kärsinyt tän takia :D (31.3.2023)
